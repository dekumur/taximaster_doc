...
$stmt = $conn->prepare("SELECT id FROM sections WHERE slug = 'web_services'");
...
<head>
    ...
    <title>Веб-сервисы - TaxiMaster</title>
...
<body>
    ...
    <div class="breadcrumb">
        <div class="container">
            ...
            <span>Веб-сервисы Такси-Мастер</span>
        </div>
    </div>
    <div class="page-layout">
        <div class="container page-layout__inner">
            ...
            <?php endif; ?>
        <?php else: ?>
            <h1 class="content-title">Веб-сервисы Такси-Мастер</h1>
            <ul class="content-list">
                <?php if (!empty($articles)): ?>
                    <?php foreach ($articles as $item): ?>
                        <li>
                            <a href="web_services.php?article=<?= $item['slug'] ?>">
